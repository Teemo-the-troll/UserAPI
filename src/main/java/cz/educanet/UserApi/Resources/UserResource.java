...
public class UserResource {
    ...
    @GET
    public Response getUsers(@HeaderParam("token") String token) throws SQLException {
    ...
    @GET
    @Path("{id}")
    public Response getUser(@PathParam("id") String id, @HeaderParam("token") String token) throws SQLException {
        if (auth.validateToken(token))
